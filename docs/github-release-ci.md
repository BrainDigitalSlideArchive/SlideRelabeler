...
1. Bump `"version"` in [`package.json`](../package.json) (e.g. to `0.9.3`).
...
The workflow **fails** if the tag is not exactly `v` + `package.json` `version` (e.g. tag `v0.9.3` requires `"version": "0.9.3"`).
