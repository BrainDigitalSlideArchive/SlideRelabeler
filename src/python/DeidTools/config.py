## TO DO: ADD GITHUB LINK TO THIS RAW FILE
...
defaultConfig = {
    ...
    "phi_pii_types": [
        ...
        {"category": "Demographics", "key": "Demographics", "text": "Demographics"},
        {
            "category": "Facility_Physician",
            "key": "Facility_Physician",
            "text": "Facility/Physician Information",
        },
        {"category": "Other_PHIPII", "key": "Other_PHIPII", "text": "Other PHI/PII"},
    ],
}


def getConfig(key=None, fallback=None):
    configDict = defaultConfig.copy()
    if key is None:
