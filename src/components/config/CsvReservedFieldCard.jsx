...
export default function CsvReservedFieldCard({
  ...
  return (
    <div className="csv-reserved-field-card" ref={cardRef}>
      <p className="csv-reserved-field-card__title">
        <span className="csv-reserved-field-card__role">
          {role}
          {required && (
            <span className="csv-reserved-field-card__required"> (required)</span>
          )}
          :
        </span>{' '}
        <span className="csv-reserved-field-card__helper">{helper}</span>
      </p>

      <div className="csv-reserved-field-card__aliases">
        <div className="csv-reserved-field-card__alias-row csv-reserved-field-card__alias-row--default">
          <span className="csv-reserved-field-card__alias-label">Default header name</span>
          <code className="csv-reserved-field-card__default-value">{defaultHeader}</code>
          <button
            type="button"
            className="csv-reserved-field-card__icon-btn csv-reserved-field-card__icon-btn--remove"
            disabled
        ...
        {draftAlternates.map((alias, index) => (
          <div
            key={`${role}-alt-${index}`}
            className="csv-reserved-field-card__alias-row"
            data-alternate-index={index}
          >
            <span className="csv-reserved-field-card__alias-label">Alternate header name</span>
            <InputText
              disabled={disabled}
              omitLabel
              variant="onLight"
            ...
            />
            <div className="csv-reserved-field-card__alias-actions">
              <button
                type="button"
                className="csv-reserved-field-card__icon-btn"
      ...
      <div className="csv-reserved-field-card__add-row">
        <button
          type="button"
          className="csv-reserved-field-card__add-btn"
          disabled={disabled}
